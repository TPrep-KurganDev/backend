...
from domain.exam_session import ExamSession
from infrastructure.exam.exam import Exam, Card
...
class SessionFactory:
    ...
    @staticmethod
    def create_session(user: User, exam: Exam, strategy: str = "full", n: int=None ,db: Session=Depends(get_db)) -> ExamSession:
    ...
    @staticmethod
    def get_smart_cards(user_id: int, exam_id: int, limit: int, db: Session=Depends(get_db)) -> list[int]:
        stats = (
