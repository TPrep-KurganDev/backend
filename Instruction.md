...
Создаёте файл '.env' и пишите в него такое (Создавать бд не обязательно, достаточно указать имя)
...
1. Скрипт проверит наличие базы данных, указанной в DATABASE_URl на локальном PostgreSQL сервере (Если бд создана, выдаст ошибку FAILED: No 'script_location' key found in configuration., её следует игнорировать).  
